...
export default function ShoppingPage() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      {/* Categories Grid */}
      <div className="bg-white grid grid-cols-4 gap-y-3 p-4 mb-2">
        {PRODUCT_CATEGORIES.map((cat) => (
          <button key={cat.key} className="flex flex-col items-center gap-1.5">
      ...
      {/* Promo Banner */}
      <div className="mx-4 my-3 bg-[#FF6B35] rounded-xl p-5">
        <p className="text-base font-bold text-white">신규 가입 혜택</p>
