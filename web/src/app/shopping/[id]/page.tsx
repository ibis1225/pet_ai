    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="md:grid md:grid-cols-2 md:gap-6">
          ...
          {/* Info */}
          <div>
            <div className="p-5 md:pt-0 space-y-2.5">
            ...
            <div className="hidden md:flex gap-3 px-5 pb-5">
              <button className="flex-1 h-12 border-2 border-[#FF6B35] text-[#FF6B35] font-semibold rounded-xl text-sm hover:bg-[#FF6B35]/5 transition">
                장바구니 담기
              </button>
              <button className="flex-1 h-12 bg-[#FF6B35] text-white font-semibold rounded-xl text-sm hover:bg-[#FF6B35]/90 transition">
                바로 구매
              </button>
            </div>
          </div>
        ...
        {/* Description */}
        <div className="p-5 md:px-6 pb-24 md:pb-8">
        ...
        <div className="md:hidden fixed bottom-0 left-0 right-0 flex gap-3 p-4 bg-white border-t border-gray-100">
